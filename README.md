...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/tic-tac-toe-ai.git
   cd tic-tac-toe-ai
   ```
...
[![Repo](https://img.shields.io/badge/tic-tac-toe-ai-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/tic-tac-toe-ai)
